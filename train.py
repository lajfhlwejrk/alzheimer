...
# input dataset
train_jpg = np.array(glob.glob(r'/home/haotian/ad_nc_classification_orchid/dataset/train_all/*/*.png'))
...
for flod_idx, (train_idx, val_idx) in enumerate(skf.split(train_jpg, train_jpg)):    
    ...
    for epoch in range(10):
        ...
        if val_acc.avg.item() > best_acc:
            ...
            torch.save(model.state_dict(), r'/home/haotian/ad_nc_classification_orchid/output/orchid_0716_all_v3{0}.pt'.format(flod_idx))
    break